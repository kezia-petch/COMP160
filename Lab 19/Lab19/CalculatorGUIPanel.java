...
public class CalculatorGUIPanel extends JPanel {
  ...
  private class ButtonListener implements ActionListener{
    ...
    /** uses the calculator method to calculate the number inputted
      * operators are stored as last operator until equals is pushed */
